...
if {$make_assignments} {
	...
	set_global_assignment -name QIP_FILE QD1/synthesis/QD1.qip
	...
	set_instance_assignment -name IO_STANDARD "3.3-V LVCMOS" -to egm_leds[3]
	set_instance_assignment -name IO_STANDARD "3.3-V LVCMOS" -to egm_leds[2]
	set_instance_assignment -name IO_STANDARD "3.3-V LVCMOS" -to egm_leds[1]
	set_instance_assignment -name IO_STANDARD "3.3-V LVCMOS" -to egm_leds[0]
	...
	set_location_assignment PIN_7 -to  egm_leds[1]
	set_location_assignment PIN_10 -to egm_leds[0]
	set_location_assignment PIN_12 -to leds[3]
	set_location_assignment PIN_41 -to egm_leds[3]
	set_location_assignment PIN_38 -to egm_leds[2]
